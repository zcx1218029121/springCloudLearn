...
import com.zcx.common.entity.system.LoginLog;
import com.zcx.common.entity.system.SystemUser;
import com.zcx.common.util.SortUtil;
import com.zcx.common.util.ZcxUtil;
import com.zcx.server.system.mapper.LoginLogMapper;
import com.zcx.server.system.service.ILoginLogService;
...
public class LoginLogServiceImpl extends ServiceImpl<LoginLogMapper, LoginLog> implements ILoginLogService {
    ...
    public IPage<LoginLog> findLoginLogs(LoginLog loginLog, QueryRequest request) {
        ...
        SortUtil.handlePageSort(request, page, "loginTime", ZcxConstant.ORDER_DESC, true);
    ...
    public void saveLoginLog(LoginLog loginLog) {
        ...
        String ip = ZcxUtil.getHttpServletRequestIpAddress();
        loginLog.setIp(ip);
